...
const MemberProfile: FC<{
  ...
  <Link href={link} className="bg-white bg-opacity-90 shadow-lg rounded-lg p-6 mb-8 flex flex-col items-center transition-transform transform hover:scale-105">
    <Image src={photo} alt={name} className="rounded-full w-32 h-32 mb-4 object-cover" />
          ...
          <div className="z-10 max-w-screen-lg px-4 lg:px-0">
            ...
            <div className="bg-white bg-opacity-80 shadow-lg rounded-lg p-8">
              ...
              <p className="text-center text-gray-700 mb-8">
                Aquí se presentan a diversos ex-integrantes o colaboradores a los cuales agradecemos por su valiosa contribución.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <MemberProfile
                  name="Dr. Juan Pérez"
