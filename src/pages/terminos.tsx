...
const TermsOfService: FC = memo(() => {
  return (
    <Page description="Términos de uso del servicio proporcionado." title="Términos de Uso">
      <Header />
        ...
        <div className="relative min-h-screen w-full flex justify-center items-center">
          ...
          <div className="z-10 max-w-screen-lg px-4 lg:px-0">
            ...
            <article className="relative p-6 bg-white bg-opacity-90 shadow-lg rounded-lg mb-8">
              {/* Botón Volver */}
              <Link href="/contacto">
                <button className="absolute top-4 right-4 px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300">
                  Volver
                </button>
              </Link>
              ...
              <p className="text-lg text-gray-700 mt-4 mb-4">
                Al acceder y utilizar nuestro servicio, usted acepta estar sujeto a estos términos de uso y a todas las
                leyes y regulaciones aplicables. Si no está de acuerdo con estos términos, le recomendamos que no
                utilice nuestro servicio.
              </p>

              <h2 className="text-2xl font-semibold text-blue-700 mb-4">2. Modificaciones</h2>
              <p className="text-lg text-gray-700 mt-4 mb-4">
                Nos reservamos el derecho de modificar estos términos en cualquier momento. Le recomendamos que revise
              ...
              <p className="text-lg text-gray-700 mt-4 mb-4">
                Usted se compromete a utilizar el servicio de manera responsable y a no realizar actividades que puedan
              ...
              <p className="text-lg text-gray-700 mt-4 mb-4">
                No seremos responsables de ningún daño directo, indirecto, incidental, especial o consecuente que surja
                del uso o la incapacidad de uso del servicio.
              </p>

              <h2 className="text-2xl font-semibold text-blue-700 mb-4">5. Legislación Aplicable</h2>
              <p className="text-lg text-gray-700 mt-4 mb-4">
                Estos términos se regirán e interpretarán de acuerdo con las leyes de [Tu País]. Cualquier disputa que
                surja en relación con estos términos será resuelta en los tribunales de [Tu País].
              </p>
